...
- **Everything you need** — Jellyfin, Sonarr, Radarr, Prowlarr, Bazarr, Jellyseerr, qBittorrent, SABnzbd, Pi-hole, WireGuard, Cloudflare Tunnel. Modular — skip what you don't need, add what you do (e.g. Lidarr).
